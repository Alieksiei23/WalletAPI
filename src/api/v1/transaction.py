...
from src.core.exceptions.exceptions import UserNotExistsException,\
    BadRequestDataException, NegativeBalanceException, TransactionNotExistsException, \
...
from src.api.shema.python_models import *
from core.config import SessionDep, get_async_session


router = APIRouter()


@router.get("/transactions", response_model=typing.Optional[list[TransactionModel]] | None, status_code=status.HTTP_200_OK)
...
@router.post("/{user_id}/transactions", response_model=typing.Optional[TransactionModel] | None, status_code=status.HTTP_200_OK)
